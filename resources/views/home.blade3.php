...
@section('content')
    ...
    <html>
        <head> 
            ...
            <title>Sistema de Conteúdo - Btm</title>
            <!-- Favicon -->
            <link rel="icon" href="assets2/img/brand/favicon.png" type="image/png">
            <!-- Fonts -->
            <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700">
            <!-- Icons -->
            <link rel="stylesheet" href="assets2/vendor/nucleo/css/nucleo.css" type="text/css">
            <link rel="stylesheet" href="assets2/vendor/@fortawesome/fontawesome-free/css/all.min.css" type="text/css">
            <!-- Page plugins -->
            <!-- Argon CSS -->
            <link rel="stylesheet" href="assets2/css/argon.css?v=1.2.0" type="text/css">
        </head>
        ...
        <body>
                    ...
                    <!-- <ul class="navbar-nav align-items-center  ml-md-auto ">
                        ...
                        <div class="dropdown-menu dropdown-menu-xl  dropdown-menu-right  py-0 overflow-hidden">
                            ...
                            <a href="#!" class="list-group-item list-group-item-action">
                                ...
                                <div class="col-auto">
                                    <img alt="Image placeholder" src="assets2/img/theme/team-1.jpg" class="avatar rounded-circle">
                                </div>
                                <div class="col ml--2">
                            ...
                            <a href="#!" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                <div class="col-auto">
                                    <img alt="Image placeholder" src="assets2/img/theme/team-2.jpg" class="avatar rounded-circle">
                                </div>
                                <div class="col ml--2">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <div>
                            ...
                            <a href="#!" class="list-group-item list-group-item-action">
                                ...
                                <div class="col-auto">
                                    ...
                                    <img alt="Image placeholder" src="assets2/img/theme/team-3.jpg" class="avatar rounded-circle">
                                </div>
                                <div class="col ml--2">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <div>
                            ...
                            <a href="#!" class="list-group-item list-group-item-action">
                                ...
                                <div class="col-auto">
                                    ...
                                    <img alt="Image placeholder" src="assets2/img/theme/team-4.jpg" class="avatar rounded-circle">
                                </div>
                                <div class="col ml--2">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <div>
                            ...
                            <a href="#!" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                <div class="col-auto">
                                    <img alt="Image placeholder" src="assets2/img/theme/team-5.jpg" class="avatar rounded-circle">
                                </div>
                                <div class="col ml--2">
                                    <div class="d-flex justify-content-between align-items-center">
                                    <div>
                    ...
                    <ul class="navbar-nav align-items-center  ml-auto ml-md-12 ">
                        ...
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="avatar avatar-sm rounded-circle">
                                <img alt="Image placeholder" src="assets2/img/theme/team-4.jpg">
                            </span>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="nav-wrapper">
                            <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                                ...
                                <!-- PAINEL 6 -->
                                <li class="nav-item">
                                    <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-6-tab" data-toggle="tab" href="#tabs-icons-text-6" role="tab" aria-controls="tabs-icons-text-6" aria-selected="false">Áreas de Atuação</a>
                                </li>
                                <!-- PAINEL 7 -->
                                <li class="nav-item">
                                ...
                                <!-- PAINEL 8 -->
                                <li class="nav-item">
                                    <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-8-tab" data-toggle="tab" href="#tabs-icons-text-8" role="tab" aria-controls="tabs-icons-text-7" aria-selected="false">Carreira</a>
                                </li>
                                <!-- PAINEL 9 -->
                                <li class="nav-item">
                                    <a class="nav-link mb-sm-3 mb-md-0" id="tabs-icons-text-9-tab" data-toggle="tab" href="#tabs-icons-text-9" role="tab" aria-controls="tabs-icons-text-7" aria-selected="false">Rodapé</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <div class="tab-pane fade show active" id="tabs-icons-text-1" role="tabpanel" aria-labelledby="tabs-icons-text-1-tab">
                                        <form action="{{route('topo1')}}" method="post">
                                            <div class="row">
                                                ...
                                                <button type="submit"  class="btn btn-icon btn-primary" style="margin: auto;" >
            ...
            <script src="assets2/vendor/js-cookie/js.cookie.js"></script>
            <script src="assets2/vendor/jquery.scrollbar/jquery.scrollbar.min.js"></script>
            <script src="assets2/vendor/jquery-scroll-lock/dist/jquery-scrollLock.min.js"></script>
            <!-- Optional JS -->
            ...
            <!-- Argon JS -->
            <script src="assets2/js/argon.js?v=1.2.0"></script>
        </body>
